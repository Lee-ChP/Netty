...
public class PacketUtil {
    ...
    private PacketUtil() {
        ...
        packetTypeMap.put(KILL_REQUEST,KillRequestPacket.class);
        packetTypeMap.put(KILL_RESPONSE,KillResponsePacket.class);
        packetTypeMap.put(SHAN_REQUEST, ShanRequestPacket.class);
        packetTypeMap.put(SHAN_RESPONSE, ShanResponsePacket.class);
